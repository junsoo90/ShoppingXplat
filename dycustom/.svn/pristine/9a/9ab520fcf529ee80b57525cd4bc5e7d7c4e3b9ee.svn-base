	...
	function stockCheck(){
		...
		$.ajax({
            ...
            success : function(mav) {
            	if(!mav.result  && mav.result != undefined){
            		alert(mav.msg);
            		bol = false;
            	}
            },
...
<script>
	function imageChange(savefilename){
		var src = "/dyadmin/upload/"+savefilename;
	...
	<div class="form-div">
		<form name = "detailform">
			...
			<div class="product-option">
				<div class="image-div">
					<div class="main-image-div">
						<img class="main-image" src="/dyadmin/upload/${vo.savefilename}" 
							width="600px" height="400px">
					</div>
					<div class="sub-image-div">
						<c:forEach var="photolist" items="${photolist}" varStatus="i">
							<img class="sub-image" src="/dyadmin/upload/${photolist.savefilename}" 
					...
					<div class="pOption-div">
						<select name="selectBox" id="selectBox"
							...
							<c:forEach var="list" items="${optionlist}" varStatus="status">
								...
								<option class="option" value="${status.index}">									
					...
					<div class="price-div">
						<div class="delivery-price-div">
							...
							<input type="hidden" class="price" name="deliveryCharge" id="deliveryCharge" 
								value="${vo.deliveryCharge}" readonly="readonly">원					
						</div>
			...
			<div class="product-detail-div">			
				<input type="hidden" class="product-detail" name="pDetail" value="${vo.pDetail }"
					readonly="readonly">	
				<img class="detail-image" src="${pageContext.request.contextPath}/img/detail.jpg" 
				width="100%" >				
			</div>
