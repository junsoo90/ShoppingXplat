	...
	function checkedBoxComfirm(){
	    ...
	    $("input:checkbox[name='cartCheckBox']:checked").each(function(){    
			...
			<c:forEach var="tempList" items="${cartList}">
				...
				json.productState = "${tempList.productState}";
	...
	function stockCheck(){
		...
		$.ajax({
            ...
            success : function(mav) {
            	...
            	if(!mav.result || mav.result == 'false'){
            		alert(mav.msg);
            		bol = false;
            		return false;
            	}
										...
										<td class="product-info-td">
											<div class="product-info-div">
												<div class="product-image">
													<img src="/dyadmin/upload/${cartList.savefilename}" width="50" height="50"> 
												</div>
